                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_text text-center">
                            <div class="login_part_text_iner">
                                ...
                                <a href="<?= site_url('/signup'); ?>" class="btn_3">Create an Account</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                ...
                                <form class="row contact_form" action="<?= site_url('login/auth'); ?> " method="post" novalidate="novalidate">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <a class="lost_pass" style="cursor: pointer;" href="#">forget password?</a>
                                    </div>
                                </form>
                            </div>
                        </div>
